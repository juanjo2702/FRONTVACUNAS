                ...
                <q-card>
                    <q-card-section class="row q-col-gutter-md">
                        ...
                        <div class="col-8">
                            ...
                            <!-- Botones -->
                            <div class="row q-col-gutter-md">
                                <q-btn flat icon="edit" color="primary" @click="openEditMascotaModal(mascota)"
                                    label="Editar" class="col" />
            ...
            <q-card style="min-width: 60vw; max-height: 90vh;">
                ...
                <q-card-section>
                    <q-form ref="formEditMascota" @submit.prevent="submitEditMascota">
                        ...
                        <div class="row q-col-gutter-md q-mb-md">
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <q-input filled v-model="mascotaEditData.nombre" label="Nombre Mascota" lazy-rules
                                    required />
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <q-select filled v-model="mascotaEditData.genero" :options="['Macho', 'Hembra']"
                                    label="Género" />
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <q-select filled v-model="mascotaEditData.especie" :options="['Perro', 'Gato']"
                                    label="Especie" @update:model-value="onEspecieChange" />
                            </div>
                        ...
                        <div class="row q-col-gutter-md q-mb-md">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <div class="col-xs-12 col-sm-6 col-md-4">
                                    <q-input filled v-model="mascotaEditData.rangoEdad" label="Edad (0-20 años)"
                                        type="number"
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <q-input filled v-model="mascotaEditData.descripcion" label="Descripción"
...
export default {
    ...
    setup() {
        ...
        const eliminarMascota = async (mascotaId) => {
            try {
                // Llamar al endpoint para desactivar la mascota
                await api.patch(`/mascotas/${mascotaId}/desactivar`);
                ...
                // Eliminar la mascota de la lista visualmente
                mascotas.value = mascotas.value.filter(mascota => mascota.id !== mascotaId);
            } catch (error) {
                console.error("Error al desactivar la mascota:", error);
                $q.notify({
                    type: "negative",
                    message: "No se pudo desactivar la mascota.",
                });
            }
        };
