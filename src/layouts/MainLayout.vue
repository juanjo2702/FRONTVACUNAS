...
export default {
  setup() {
    ...
    const menuRoutes = [
      ...
      { path: "/PaginaMapaNoVacunados", label: "MAPA NO VACUNADOS", icon: "map", roles: [2, 3] },
      { path: "/PaginaBusquedaGeografica", label: "BUSCAR POR UBICACIÓN", icon: "my_location", roles: [2, 3] },
      { path: "/ReporteBrigadas", label: "REPORTE BRIGADAS", icon: "summarize", roles: [2, 3] },
